...
H_part1 = (1/(Q*W*L))
H_part2 = 2*L*((c0_AV/V_AV)+(c0_HD/V_HD)) + 2*L*tau_f*((c0_AV/S_AV)+(c0_HD/S_HD)) + tau_t*(c0_AV + c0_HD)
H_part3 = a_wt/(Q*W*L)
...
H_AV_part1 = (1/(Q*W*L))
H_AV_part2 = 2*L*(c0_AV/V_AV) + 2*L*tau_f*(c0_AV/S[i]) + tau_t*c0_AV
...
H_HD_part1 = (1/(Q*W*L))
H_HD_part2 = 2*L*(c0_HD/V_HD) + 2*L*tau_f*(c0_HD/S[i]) + tau_t*c0_HD
...
H_AV_part1 = (1/(Q*W*L))
H_AV_part2 = 2*L*((c0_AV/V_AV)) + 2*L*tau_f*((c0_AV/S_optimal)) + tau_t*(c0_AV)
H_AV_part3 = p_AV*a_wt/(Q*W*L)
H_AV_part4 = a*(p_AV^2)*(W/V_AV + 2*tau_r)*(c1_AV + 0.5*a_r_AV)
...
H_HD_part1 = (1/(Q*W*L))
H_HD_part2 = 2*L*((c0_HD/V_HD)) + 2*L*tau_f*((c0_HD/S_optimal)) + tau_t*(c0_HD)
H_HD_part3 = p_HD*a_wt/(Q*W*L)
H_HD_part4 = a*(p_HD^2)*(W/V_HD + 2*tau_r)*(c1_HD + 0.5*a_r_HD)
...
H_AV_part1 = (1/(Q*W*L))
H_AV_part2 = 2*L*(c0_AV/V_AV) + 2*L*tau_f*(c0_AV/S_AV) + tau_t*c0_AV
H_AV_part3 = p_AV*a_wt/(Q*W*L)
H_AV_part4 = a*(p_AV^2)*(W/V_AV + 2*tau_r)*(c1_AV + 0.5*a_r_AV)
...
H_HD_part1 = (1/(Q*W*L))
H_HD_part2 = 2*L*(c0_HD/V_HD) + 2*L*tau_f*(c0_HD/S_HD) + tau_t*c0_HD
H_HD_part3 = p_HD*a_wt/(Q*W*L)
H_HD_part4 = a*(p_HD^2)*(W/V_HD + 2*tau_r)*(c1_HD + 0.5*a_r_HD)
...
H_part1 = (1/(Q*W*L))
H_part2 = 2*L*((c0_AV/V_AV)+(c0_HD/V_HD)) + 2*L*tau_f*((c0_AV/S)+(c0_HD/S)) + tau_t*(c0_AV + c0_HD)
H_part3 = a_wt/(Q*W*L)
H_part4 = a*(p_AV^2)*(W/V_AV + 2*tau_r)*(c1_AV + 0.5*a_r_AV) + a*(p_HD^2)*(W/V_HD + 2*tau_r)*(c1_HD + 0.5*a_r_HD)
